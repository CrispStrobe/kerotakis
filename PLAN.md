...
- **Temperature-dependent Cp, the wiring half (landed #509)** — #507 landed 37 Cp(T) records
  over 35 species; #509 moved the ~40
...
- **`Vessel::heat_capacity` room-temperature residual (closed #509)** — the
  burner now pays the Cp(T) integral rather than room-temperature prices for a
  crucible at kiln temperature. #509 also names the term the two-line ledger never
...
- **Open-vessel CO₂ uptake as a rate (landed #531)** — the slow clock now
  models bounded inward room-air uptake; outward degassing remains deliberately
  instantaneous and is a separate mechanism.
