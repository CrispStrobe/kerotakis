    ...
    document.material_recipes.extend([
        ...
        MaterialRecipe {
            ...
            roles: vec![MaterialRole::FermentationCulture {
                reference_rate_per_second_per_gram_per_litre: 0.0002,
            ...
            lot_assumptions: vec![
                ...
                "the sucrose-fermentation rate is an editorial classroom timescale, quoted PER GRAM OF YEAST PER LITRE of liquid against a declared one-litre reference volume; strain growth, oxygen switching, inhibition and secondary metabolites remain unresolved. The per-litre denominator arrived on 2026-09-16 with the fix that made a fermentation first order in concentration instead of in amount, and 0.0002 was carried over unchanged rather than re-fitted, so its magnitude at a litre is unestablished".to_string(),
            ],
            substitutions: Vec::new(),
            confidence: MaterialConfidence::Surrogate,
            expansion_policy: MaterialExpansionPolicy::Fixed,
        ...
        MaterialRecipe {
            ...
            lot_assumptions: vec![
                ...
                "the sucrose-fermentation rate is an editorial classroom timescale shared by equal dry solids and quoted PER GRAM PER LITRE against a declared one-litre reference volume; strain growth, oxygen switching, inhibition and secondary metabolites remain unresolved. The per-litre denominator arrived on 2026-09-16 with the fix that made a fermentation first order in concentration instead of in amount, and 0.0002 was carried over unchanged rather than re-fitted, so its magnitude at a litre is unestablished".to_string(),
            ],
            substitutions: Vec::new(),
            confidence: MaterialConfidence::Surrogate,
            expansion_policy: MaterialExpansionPolicy::Fixed,
        ...
        MaterialRecipe {
            ...
            physical_form: MaterialPhysicalForm::Granules,
            roles: vec![MaterialRole::FermentationCulture {
                reference_rate_per_second_per_gram_per_litre: 0.000_01,
            ...
            lot_assumptions: vec![
                ...
                "0.00001 PER SECOND PER GRAM OF CULTURE PER LITRE OF LIQUID at the declared optimum is one editorial classroom timescale shared by the three cultures added with it; what differs between them is the temperature envelope and the dose, not a measured activity. Cell growth, a lag phase, inhibition by the acid the culture itself makes, nutrient depletion and strain variation are all absent. THE PER-LITRE IS NEW AND THE NUMBER IS NOT. Until 2026-09-16 the engine multiplied this by the grams of culture with no volume in the denominator, so a fermentation was first order in an AMOUNT rather than in a concentration and doubling a batch quadrupled its product. The fix divides by the vessel liquid volume against a declared one-litre reference; the value was carried over unchanged rather than re-fitted, so it is now a rate for a litre that nobody has checked, and every bench script here pours a tenth of one. The magnitude is therefore UNESTABLISHED in a way it was not before, and saying so is the honest alternative to inventing the conversion that would have kept the old outputs".to_string(),
