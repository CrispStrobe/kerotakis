...
pub struct SpeciesData {
    ...
    /// Curated sRGB, and how strongly the substance colours a solution
    /// (an absorptivity stand-in, per mol/L over a 1 cm path). Colour is
    /// curated rather than computed: real absorption spectra for the
    /// interesting ions are d–d and charge-transfer bands, which neither
    /// the thermodynamic databases nor a semi-empirical calculation
    /// deliver honestly.
    #[serde(default)]
