...
pub fn event_matches(event: &kerotakis_core::Event, claim: &str) -> bool {
    ...
    let (actual_kind, actual_species): (&str, Option<&str>) = match event {
        ...
        E::EnzymeHydrolysed { .. } => ("enzyme_hydrolysed", None),
        ...
        E::ObjectSpillBoundary { .. } => ("object_spill_boundary", None),
        E::OsmosisChanged { .. } => ("osmosis_changed", None),
        E::BrowningChanged { .. } => ("browning_changed", None),
        E::SoapScumFormed { .. } => ("soap_scum_formed", None),
        E::LemonPaperMarked { .. } => ("lemon_paper_marked", None),
        E::LemonPaperDried { .. } => ("lemon_paper_dried", None),
        E::LemonPaperBrowned { .. } => ("lemon_paper_browned", None),
