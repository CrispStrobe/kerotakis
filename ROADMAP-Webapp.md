...
Phases 0–10 — the original 119-item science roadmap (licence and provenance
rails, state and orchestration, broader aqueous/gas/surface/transport
chemistry, the generated registry, phase behaviour and apparatus, generic
kinetics, electrochemistry, structural and organic chemistry, instruments,
bounded advanced packs, delivery) — are complete, and so is Phase 11
(persistent world and mission orchestration). Every item, with its task
number and completion note, is recorded in `HISTORY.md`. No item in this
list is open; what follows is the Phase 11 narrative worth keeping.
