<script lang="ts">
  ...
  import { kidsExperimentMatches, type KidsExperiment, type KidsStatus } from "../kidsCatalog";

  let { entries, onlesson, onquest, onsandbox, onclose }: {
