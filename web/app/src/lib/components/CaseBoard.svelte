...
<style>
  ...
  .contact { position: relative; width: 68px; height: 68px; display: grid; place-items: center; border-radius: 22px; color: white; background: linear-gradient(145deg, var(--primary), var(--instrument)); font-size: 1.1rem; font-weight: 900; }.contact i { position: absolute; right: -2px; bottom: -2px; width: 18px; height: 18px; border: 3px solid var(--surface); border-radius: 50%; background: var(--success); }
  ...
  button { min-height: 38px; border: 0; border-radius: 11px; color: white; background: var(--primary); cursor: pointer; font-weight: 800; }.message button { min-width: 13rem; display: flex; align-items: center; justify-content: space-between; padding: 0 .8rem; }
  .case-complete { display: flex; align-items: center; gap: .7rem; padding: .7rem .85rem; border: 1px solid color-mix(in srgb, var(--success) 35%, var(--edge)); border-radius: 15px; background: color-mix(in srgb, var(--success) 8%, var(--surface)); }.case-complete > span { width: 34px; height: 34px; display: grid; place-items: center; flex: none; border-radius: 12px; color: white; background: var(--success); font-weight: 900; }.case-complete p { display: grid; margin: 0; color: var(--dim); font-size: .68rem; }.case-complete strong { color: var(--success); font-size: .66rem; letter-spacing: .06em; text-transform: uppercase; }
