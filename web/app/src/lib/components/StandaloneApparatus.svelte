...
{#if tool === "grind"}
  <figure class="standalone mortar" class:working aria-label={t("mortar on the bench")}>
...
<style>
  ...
  .working .pestle { animation: grind 0.5s ease-in-out infinite alternate; }
