...
> **Superseded record, 2026-09-08.** PR #504 is closed; the merge gate and
> relay protocol below are historical and are kept only to show what the
> boundary was. See `README.md` for current state and for the evidence archive.
